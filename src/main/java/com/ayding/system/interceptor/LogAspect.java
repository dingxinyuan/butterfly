...
import com.ayding.common.util.HttpContextUtils;
import com.ayding.common.util.JsonUtil;
import com.ayding.butterfly.log.domain.vo.AuthUserLogVO;
import com.ayding.system.sync.LogSyncTask;
...
public class LogAspect {
    ...
    @Pointcut(value = "@annotation(com.ayding.common.annotation.OperateLog)")
